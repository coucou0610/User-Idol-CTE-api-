...
(function () {
  ...
  function getPresets() {
    ...
    return {
      contracts: {
        name: "通告生成预设",
        system: '当用户请求"查看通告"、"刷新通告"、"刷新项目"、"刷新通告"或剧情推进到需要展示新的工作机会时，请严格按照以下格式生成通告列表。\n\n生成规则\n每种通告类别（影视、唱片、舞台、综艺、广告）必须包含 2-3 个通告。\n必须在整个列表的开头和结尾使用 <contracts> 和 </contracts> 标签包裹。\n内部每条通告必须使用方括号 [] 包裹，并用竖线 | 分隔字段。\n内容需符合娱乐圈背景。\n数值合理化，至少有一个通告匹配user的数值。\n数据格式\n<contracts>\n[通告｜通告类别｜项目名｜公司｜工作性质｜属性要求｜酬劳｜拍摄周期｜截止日期｜内容说明]\n[通告｜通告类别｜项目名｜公司｜工作性质｜属性要求｜酬劳｜拍摄周期｜截止日期｜内容说明]\n...\n</contracts>\n\n字段说明\n通告类别：仅限以下五种：\n电影电视剧 / Movie & TV series\n唱片 / Music\n舞台 / Stage (注意：仅指idol唱跳舞台、打歌节目、拼盘演唱会等。绝对禁止生成话剧、音乐剧、戏剧等"剧"类内容)\n综艺 / Variety show\n广告 / Ad\n\n项目名：\n舞台类示例：《人气歌谣》打歌舞台、MAMA颁奖礼特别舞台、草莓音乐节压轴表演。\n其他类示例：《VOGUE》银十封面、《奔跑吧》特别季。\n公司：万城娱乐、盛华集团、全球影业、索尼音乐、环球音乐、华纳音乐、大西洋唱片、电视台（如京港，M-net, PSTV，芒果台）、主办方、品牌方等。\n\n工作性质：\n舞台类：主打歌首秀、Special Stage、嘉宾。\n其他类：主角、配角、品牌代言人、广告模特。\n属性要求：列出需要的属性及数值。\n属性包含：歌艺，舞蹈，演技，魅力，气质，体能。\n格式示例：舞蹈80，歌艺75。不需要的属性用-表示。\n酬劳：金额+货币单位 CNY（符合当前idol知名度和口碑度的身价，通常在 50,000 - 500,000 CNY 之间）。除了万城娱乐为{{user}}定制的唱片录制是无额外酬劳的义务工作之外，其他所有通告都必须有酬劳。\n拍摄周期：例如：1天（舞台和广告通常较短）、20天、12期等。\n截止日期：例如：2026年5月30日\n内容说明：必填，控制在100字左右。\n非影视类格式：工作类型：[唱片/舞台/综艺/广告等]。要求：[工作内容、准备事项、风格要求、拍摄录制安排、彩排、妆造、品牌调性或注意事项]。\n影视类格式：工作类型：[电视剧/电影+角色类型/番位]。要求：[试镜/围读/进组/培训/台词/动作指导/封闭管理等要求]。剧情大纲：开头：[故事开端]。过程：[主要冲突/人物关系变化]。结尾：[故事结局]。\n\n输出示例（请严格模仿此格式输出，不要忘记首尾的标签，内容仅供参考）：\n<contracts>\n[通告｜舞台 / Stage｜音乐银行 打歌舞台｜KBS电视台｜新人首次亮相｜歌艺55，舞蹈58，魅力60，气质55，体能50，演技-｜60,000 CNY｜1天｜无截止日期｜工作类型：打歌舞台首秀。要求：需提前1天彩排，正装出席。]\n[通告｜广告 / Ad｜夏日气泡水 校园推广｜元气森林｜广告模特｜魅力62，气质60，体能55，歌艺-，舞蹈-，演技-｜50,000 CNY｜1天｜2026年6月1日｜工作类型：清新风格平面广告。要求：自然妆容，体现青春活力气质。]\n[通告｜综艺 / Variety show｜偶像直播间 拼盘综艺｜PSTV｜飞行嘉宾｜口才65，魅力60，气质58，体能55，歌艺-，舞蹈-｜70,000 CNY｜1天录制｜2026年6月3日｜工作类型：综艺飞行嘉宾。要求：提前准备才艺展示环节，着装风格活泼。]\n[通告｜舞台 / Stage｜MCD 夏日特辑｜M-net电视台｜特别舞台合作｜舞蹈70，歌艺68，魅力72，气质65，体能68，演技-｜120,000 CNY｜2天彩排+录制｜2026年6月5日｜工作类型：打歌节目特别舞台。要求：第一天彩排走位，第二天正式录制，需自备演出服装。]\n[通告｜电影电视剧 / Movie & TV series｜青春校园网剧《那年九月》｜全球影业｜男三号 / 女三号｜演技72，魅力70，气质68，体能60，歌艺-，舞蹈-｜150,000 CNY｜20天｜2026年6月1日｜工作类型：青春校园网剧（男三号/女三号）。要求：封闭拍摄，需提前三天进组。剧情大纲：开头：校园新生相遇，命运交错；过程：在误会与竞争中逐渐靠近，共同面对青春难题；结尾：彼此成长，以最好的姿态告别青涩岁月。]\n[通告｜唱片 / Music｜数码单曲《初雨》｜万城娱乐｜音源录制｜歌艺78，舞蹈-，魅力75，气质70，体能-，演技-｜无额外酬劳（公司分成）｜7天｜2026年6月10日｜工作类型：个人数码单曲录制。要求：全程在公司录音棚完成，需配合后期混音调整。]\n[通告｜综艺 / Variety show｜丛林生存法则｜芒果台｜常驻成员｜体能85，气质75，魅力80，口才78，歌艺-，舞蹈-｜280,000 CNY｜12期（每期3天）｜2026年7月1日｜工作类型：野外生存真人秀常驻嘉宾。要求：需接受体能测试，签署保密协议，全程不得使用手机。]\n[通告｜舞台 / Stage｜亚洲音乐盛典 颁奖礼｜主办方｜压轴表演嘉宾｜舞蹈88，歌艺85，魅力90，气质85，体能86，演技-｜400,000 CNY｜1天彩排+直播｜2026年7月15日｜工作类型：颁奖典礼压轴演出。要求：需自备完整舞台方案及编舞，彩排后不得更改曲目。]\n[通告｜广告 / Ad｜国民运动鞋 春夏系列｜特步｜品牌挚友｜魅力88，气质85，体能82，歌艺-，舞蹈-，演技-｜320,000 CNY｜2天｜2026年7月20日｜工作类型：运动品牌平面与视频广告。要求：第一天拍平面，第二天拍视频，需展现运动活力形象。]\n[通告｜电影电视剧 / Movie & TV series｜悬疑电影《消失的第八层》｜盛华集团｜主角｜演技92，魅力90，气质88，体能85，歌艺-，舞蹈-｜500,000 CNY｜45天｜2026年8月1日｜工作类型：悬疑惊悚电影主角。要求：全程封闭拍摄，需提前两周进组。剧情大纲：开头：主角意外卷入连环失踪案；过程：在追查真相中发现自己也是目标，与幕后黑手展开博弈；结尾：揭开惊天阴谋，却付出沉重代价。]\n</contracts>',
        userPrompt: "请严格按格式生成通告列表，每条必须包含全部10个字段（含截止日期和内容说明），内容说明控制在100字以内，直接输出<contracts>标签，不要任何前言。",
      },
      shop: {
        name: "商店生成预设",
